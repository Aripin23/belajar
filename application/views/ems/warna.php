                    ...
                    <tbody>
                        <?php $no=1; foreach($data as $d ) {?>
                            <tr>
                                ...
                                <td><?= $d->warna?></td>
                                <td>
                                <?= '<a href=# onclick="editEms(\'' . $d->kode . '\',\'' . $d->kode . '\')" class="btn btn-warning" data-toggle="modal" data-target="#editEms"><i class="fas fa-pencil-alt pr-2" aria-hidden="true"></i>Edit</a>';
                                    ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="emsModal">Tambah Warna</h5>
