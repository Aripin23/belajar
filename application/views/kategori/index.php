                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                              <a class="btn btn-primary" href="<?= base_url('Kategori/form_add');?>">Tambah</a>  
                            </li>
                        </ul>
                                                ...
                                                <table id="datatable"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td><?= $kat->slug ?></td>
                                                            <td>
                                                                <a href="<?= base_url('kategori/form_update/'.$kat->id) ?>">Edit</a> |
                                                                 <a href="<?= base_url('kategori/delete/'.$kat->id) ?>">Delete</a>
                                                            </td>
                                                        </tr>
                                                        <?php }?>
                                                    </tbody>
